...
export const ja: Translation = {
	...
	[Key.aboutWebsite]: "このサイトについて",
	[Key.placesTitle]: "足跡",
	[Key.placesSubtitle]: "訪れた場所の記録",
	[Key.placesVisitedProvinces]: "訪問した地域",
	[Key.placesStatLocationsUnit]: "か所",
	[Key.placesStatVisitsUnit]: "回の旅行",
	[Key.placesStatThisYearUnit]: "今年の旅行",
	[Key.placesLatestTrip]: "最近の旅行",
	[Key.placesMap]: "旅行マップ",
	[Key.placesList]: "旅行一覧",
	[Key.placesMapLoadFailed]: "地図を読み込めませんでした",
	[Key.placesNeedAmapKey]: "AMap キーが必要です",
	[Key.placesFilterAllFootprints]: "すべての旅行",
	[Key.placesClusterDisplay]: "マーカーをまとめる",
	[Key.placesMapOwnerLocation]: "現在地",
	[Key.placesClusterTrips]: " 件の旅行",
	[Key.placesFullscreen]: "全画面",
	[Key.placesRefresh]: "リセット",
	[Key.placesMapCredit]: "地図データ：AMap",
	[Key.placesNoData]: "旅行記録がありません",
	[Key.placesNoDataHint]: "旅行はまだ記録されていません",
	[Key.placesUnknownProvince]: "不明な地域",
	[Key.placesBackToTrips]: "旅行一覧に戻る",
	[Key.placesTripDetail]: "旅行の詳細",
	[Key.placesLocationCount]: "か所",
	[Key.placesLocations]: "訪問場所",
	[Key.placesViewOnMap]: "地図で見る",
};
