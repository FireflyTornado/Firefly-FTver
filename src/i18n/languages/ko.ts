...
export const ko: Translation = {
	...
	[Key.musicTimeout]: "재생목록 요청 시간이 초과되었습니다",
	[Key.musicRetry]: "다시 시도",
	[Key.musicPlay]: "재생",
	[Key.musicPause]: "일시정지",
	...
	[Key.aboutWebsite]: "사이트 소개",
	[Key.placesTitle]: "여행 발자취",
	[Key.placesSubtitle]: "방문한 장소의 기록",
	[Key.placesVisitedProvinces]: "방문한 지역",
	[Key.placesStatLocationsUnit]: "개 장소",
	[Key.placesStatVisitsUnit]: "회 여행",
	[Key.placesStatThisYearUnit]: "올해 여행",
	[Key.placesLatestTrip]: "최근 여행",
	[Key.placesMap]: "여행 지도",
	[Key.placesList]: "여행 목록",
	[Key.placesMapLoadFailed]: "지도를 불러오지 못했습니다",
	[Key.placesNeedAmapKey]: "AMap 키가 필요합니다",
	[Key.placesFilterAllFootprints]: "모든 여행",
	[Key.placesClusterDisplay]: "마커 묶기",
	[Key.placesMapOwnerLocation]: "내 위치",
	[Key.placesClusterTrips]: "개 여행",
	[Key.placesFullscreen]: "전체 화면",
	[Key.placesRefresh]: "초기화",
	[Key.placesMapCredit]: "지도 데이터: AMap",
	[Key.placesNoData]: "여행 기록이 없습니다",
	[Key.placesNoDataHint]: "아직 기록된 여행이 없습니다",
	[Key.placesUnknownProvince]: "알 수 없는 지역",
	[Key.placesBackToTrips]: "모든 여행으로 돌아가기",
	[Key.placesTripDetail]: "여행 상세",
	[Key.placesLocationCount]: "개 장소",
	[Key.placesLocations]: "방문 장소",
	[Key.placesViewOnMap]: "지도에서 보기",
};
