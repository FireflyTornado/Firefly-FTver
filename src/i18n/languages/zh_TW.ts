...
export const zh_TW: Translation = {
	...
	[Key.aboutWebsite]: "關於本站",
	[Key.placesTitle]: "足跡",
	[Key.placesSubtitle]: "記錄我曾經到訪過的地方",
	[Key.placesVisitedProvinces]: "已到訪省份",
	[Key.placesStatLocationsUnit]: "個地點",
	[Key.placesStatVisitsUnit]: "次旅行",
	[Key.placesStatThisYearUnit]: "今年足跡",
	[Key.placesLatestTrip]: "最近一次旅行",
	[Key.placesMap]: "足跡地圖",
	[Key.placesList]: "旅行列表",
	[Key.placesMapLoadFailed]: "地圖載入失敗",
	[Key.placesNeedAmapKey]: "需要設定高德地圖 Key",
	[Key.placesFilterAllFootprints]: "全部旅行",
	[Key.placesClusterDisplay]: "聚合顯示",
	[Key.placesMapOwnerLocation]: "我的位置",
	[Key.placesClusterTrips]: " 個旅行",
	[Key.placesFullscreen]: "全螢幕",
	[Key.placesRefresh]: "重設",
	[Key.placesMapCredit]: "地圖資料由高德地圖提供",
	[Key.placesNoData]: "暫無旅行",
	[Key.placesNoDataHint]: "還沒有記錄任何旅行",
	[Key.placesUnknownProvince]: "未知地區",
	[Key.placesBackToTrips]: "返回全部旅行",
	[Key.placesTripDetail]: "旅行詳情",
	[Key.placesLocationCount]: "個地點",
	[Key.placesLocations]: "行程地點",
	[Key.placesViewOnMap]: "在地圖查看",
};
