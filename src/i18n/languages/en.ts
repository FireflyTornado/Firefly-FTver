...
export const en: Translation = {
	...
	[Key.musicTimeout]: "Playlist request timed out",
	[Key.musicRetry]: "Retry",
	[Key.musicPlay]: "Play",
	...
	[Key.aboutWebsite]: "About This Site",
	[Key.placesTitle]: "Places",
	[Key.placesSubtitle]: "A record of the places I have visited",
	[Key.placesVisitedProvinces]: "Provinces visited",
	[Key.placesStatLocationsUnit]: "locations",
	[Key.placesStatVisitsUnit]: "trips",
	[Key.placesStatThisYearUnit]: "trips this year",
	[Key.placesLatestTrip]: "Latest trip",
	[Key.placesMap]: "Travel map",
	[Key.placesList]: "Trips",
	[Key.placesMapLoadFailed]: "Failed to load the map",
	[Key.placesNeedAmapKey]: "An AMap key is required",
	[Key.placesFilterAllFootprints]: "All trips",
	[Key.placesClusterDisplay]: "Cluster markers",
	[Key.placesMapOwnerLocation]: "My location",
	[Key.placesClusterTrips]: " trips",
	[Key.placesFullscreen]: "Fullscreen",
	[Key.placesRefresh]: "Reset",
	[Key.placesMapCredit]: "Map data provided by AMap",
	[Key.placesNoData]: "No trips yet",
	[Key.placesNoDataHint]: "No trips have been recorded yet",
	[Key.placesUnknownProvince]: "Unknown area",
	[Key.placesBackToTrips]: "Back to all trips",
	[Key.placesTripDetail]: "Trip details",
	[Key.placesLocationCount]: "locations",
	[Key.placesLocations]: "Locations",
	[Key.placesViewOnMap]: "View on map",
};
