...
export const ru: Translation = {
	...
	[Key.aboutWebsite]: "О сайте",
	[Key.placesTitle]: "Путешествия",
	[Key.placesSubtitle]: "Места, которые я посетил",
	[Key.placesVisitedProvinces]: "Посещено регионов",
	[Key.placesStatLocationsUnit]: "мест",
	[Key.placesStatVisitsUnit]: "поездок",
	[Key.placesStatThisYearUnit]: "поездок в этом году",
	[Key.placesLatestTrip]: "Последняя поездка",
	[Key.placesMap]: "Карта путешествий",
	[Key.placesList]: "Список поездок",
	[Key.placesMapLoadFailed]: "Не удалось загрузить карту",
	[Key.placesNeedAmapKey]: "Требуется ключ AMap",
	[Key.placesFilterAllFootprints]: "Все поездки",
	[Key.placesClusterDisplay]: "Группировать метки",
	[Key.placesMapOwnerLocation]: "Моё местоположение",
	[Key.placesClusterTrips]: " поездок",
	[Key.placesFullscreen]: "На весь экран",
	[Key.placesRefresh]: "Сбросить",
	[Key.placesMapCredit]: "Картографические данные AMap",
	[Key.placesNoData]: "Поездок пока нет",
	[Key.placesNoDataHint]: "Пока не записано ни одной поездки",
	[Key.placesUnknownProvince]: "Неизвестный регион",
	[Key.placesBackToTrips]: "Вернуться ко всем поездкам",
	[Key.placesTripDetail]: "Детали поездки",
	[Key.placesLocationCount]: "мест",
	[Key.placesLocations]: "Места",
	[Key.placesViewOnMap]: "Показать на карте",
};
